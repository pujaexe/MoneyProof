...
export type DocumentDownloadSvgrepoComsvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function DocumentDownloadSvgrepoComsvgIcon(
  props: DocumentDownloadSvgrepoComsvgIconProps
) {
...
export default DocumentDownloadSvgrepoComsvgIcon;
/* prettier-ignore-end */
